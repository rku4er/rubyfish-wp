...
<div class="parallax-image-wrapper" data-anchor-target=".hero-bg" data-bottom-top="transform:translate3d(0px, 200%, 0px)" data-top-bottom="transform:translate3d(0px, 0%, 0px)">
    ...
    <div class="parallax-image" style="background-image:url(http://d2gawdwh5o4in5.cloudfront.net/wp-content/themes/rubyfish/assets/img/blog-bg.jpg)" data-anchor-target=".hero-bg" data-bottom-top="transform: translate3d(0px, -60%, 0px);"
...
<div id="skrollr-body">
    ...
    <div class="hero-bg" style="background-image:url(http://d2gawdwh5o4in5.cloudfront.net/wp-content/themes/rubyfish/assets/img/blog-bg.jpg);"></div>

    <div id="hero">

        <div class="hero-text">
            <h2><span>If I forget the words, they weren't very memorable in the first place</span></h2>
            <p>Willie Nelson</p>
        </div>
